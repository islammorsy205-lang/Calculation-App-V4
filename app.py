...
if generate_doc_btn:
    ...
    if errors: 
        ...
        with st.spinner("🔄 Running Advanced 3-Moment Equation Solver & Building Document..."):
            ...
            # 💡 الجراحة الذكية للسطر المرجعي: محاذاة لليمين + إلغاء النقاط المزعجة
            def add_reference_line(doc_obj, item_name, ds_map):
                ...
                if not matched_page:
                    matched_page = " " # مسافة فارغة بدلاً من النقاط المزعجة
            ...
            # 💡 إجبار المحاذاة لليسار غصب عن القالب العربي RTL
