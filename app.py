...
if generate_doc_btn:
    ...
    if errors: 
        ...
        with st.spinner("🔄 Running Advanced 3-Moment Equation Solver & Building Document..."):
            ...
            # 💡 الجراحة الذكية للسطر المرجعي: محاذاة لليمين + نقط افتراضية لو مش موجودة + كشف المسميات بدقة
            ...
            if ds_page_map:
                ...
                for k, v in ds_page_map.items():
                    add_eq(doc, f"   1.{idx_c} Datasheet for {k} ........................................ Page {v}")
                    idx_c += 1
                doc.add_paragraph()
                
            if design_loads_page:
                add_heading_14(doc, "2. Design Loads:")
                add_eq(doc, f"   2.1 Design Loads .................................................... Page {design_loads_page}")
                doc.add_paragraph()
                
            # 💡 تفريع الفهرس كما طلب الاستشاري بالظبط في الصور بخط يده مع أرقام الصفحات الحقيقية
            add_heading_14(doc, "3. Formwork Elements Calculations:")
            for i_idx, (elem_title, sub_items_list) in enumerate(idx_data):
                add_eq(doc, f"   3.{i_idx+1} {elem_title}")
                for j_idx, (sub_name, p_num) in enumerate(sub_items_list):
                    add_eq(doc, f"        {j_idx+1}- {sub_name} ........................................ Page {p_num}")
                doc.add_paragraph()
            ...
            # 💡 الجراحة الثانية: تغيير كود 2018 إلى SBC 2024
            if "BS" in ref_code: 
