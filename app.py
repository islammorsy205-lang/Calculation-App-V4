...
# ==========================================
# 🛡️ 2. SECURITY SYSTEM & AUTHENTICATION (NEW)
# ==========================================
...
# ==========================================
# 4. Old Authentication (Kept for structural integrity but overridden by new system)
# ==========================================
...
# تعيين صلاحيات النظام القديم بناءً على الدخول السري الجديد
...
with st.sidebar:
    ...
    if is_admin_user:
        ...
        st.markdown(f"**🟢 Active Users (System):** {auth.track_active_users()}")
    else: 
        st.info("👷‍♂️ Standard User Portal")
        st.markdown(f"Logged in as:<br>**{st.session_state['user_email']}**", unsafe_allow_html=True)
