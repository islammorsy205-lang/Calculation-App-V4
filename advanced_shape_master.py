# ==============================================================================
# ADVANCED SHAPE MASTER - ENGINEERING CALCULATION MODULE (V19 - Ultimate AI)
# ==============================================================================
...
try:
    ...
    pytesseract = None
    st.warning("⚠️ مكتبة 'pytesseract' غير موجودة. لتحليل الصور، اكتب 'pip install pytesseract'.")
...
# =========================================================
# 5. Main Streamlit UI (Smart Topology & Dynamic UX)
# =========================================================
def render_advanced_shape_module():
    ...
    # 💡 الميزة الجديدة: إدخال هندسي مانيوال بدون كاد
